...
export default function Chirp({ chirp }) {
    ...
    const renderMedia = (media) => {
        const mediaUrl = `/storage/${media}`;  // Mengakses media di storage

        // Cek apakah media adalah gambar atau video
        if (media.endsWith('.mp4') || media.endsWith('.mov') || media.endsWith('.avi')) {
            return (
            ...
            return <img src={mediaUrl} alt="Chirp Media" className="max-w-full h-auto" />;
        }

        return null; // Jika media tidak dikenali
    };
    ...
    return (
        <div className="p-6 flex space-x-2">
            ...
            <div className="flex-1">
                <div className="flex justify-between items-center">
                    ...
                    {chirp.user.id === auth.user.id &&
                        <Dropdown>
                            <Dropdown.Trigger>
                                <button>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-400" viewBox="0 0 20 20" fill="currentColor"><path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                    </svg>
                                </button>
                            </Dropdown.Trigger>
                            <Dropdown.Content>
                ...
                {chirp.media && renderMedia(chirp.media)}
